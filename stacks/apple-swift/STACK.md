...
run-local.sh (macos, ios), run-device.sh, prepare-release.sh, deploy-testflight.sh (ios or mac), push-store-metadata.sh, release-check.sh, first-release-check.sh, release-stores.sh. Their contract is `stacks/common/DISTRIBUTION.md`.
