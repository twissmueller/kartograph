...
play_listing.py  [--dry-run]
    ...
    contactEmail/website, category is listed as manual; the template leaves defaultLanguage empty: it is chosen, never derived, GP2); one edit, commit last; length checks; prints the
