...
run-local.sh (android), prepare-release.sh, deploy-play-internal.sh, push-store-metadata.sh, release-check.sh, first-release-check.sh, release-stores.sh. Their contract is `stacks/common/DISTRIBUTION.md`.
